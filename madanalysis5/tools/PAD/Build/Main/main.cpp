...
//  if (analyzer1==0) return 1;
  ...
  std::map<std::string, std::string> prmATLAS_SUSY_2018_04;
  AnalyzerBase* analyzer_ATLAS_SUSY_2018_04 = 
      manager.InitializeAnalyzer("ATLAS_SUSY_2018_04","ATLAS_SUSY_2018_04.saf",prmATLAS_SUSY_2018_04);
  if (analyzer_ATLAS_SUSY_2018_04==0) return 1;
...
//      if (!analyzer_atlas_exot_2014_06->Execute(mySample,myEvent)) continue;
      if (!analyzer_ATLAS_SUSY_2018_04->Execute(mySample,myEvent)) continue;
    }
  }
